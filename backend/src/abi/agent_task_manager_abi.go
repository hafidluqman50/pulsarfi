...
//
// Solidity: function tradePermissions(uint256 taskId) view returns(uint256 totalBudget, uint256 usedBudget, uint64 expiresAt, uint256 maxAmountPerTrade, uint256 cooldownInterval, uint256 lastExecutedAt)
func (_AgentTaskManager *AgentTaskManagerCaller) TradePermissions(opts *bind.CallOpts, taskId *big.Int) (struct {
	...
	CooldownInterval  *big.Int
	LastExecutedAt    *big.Int
}, error) {
	var out []interface{}
	...
	outstruct.MaxAmountPerTrade = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
	outstruct.CooldownInterval = *abi.ConvertType(out[4], new(*big.Int)).(**big.Int)
	outstruct.LastExecutedAt = *abi.ConvertType(out[5], new(*big.Int)).(**big.Int)
...
// MarkActionable is a paid mutator transaction binding the contract method 0x51a6418c.
//
// Solidity: function markActionable(uint256 taskId) returns()
func (_AgentTaskManager *AgentTaskManagerTransactor) MarkActionable(opts *bind.TransactOpts, taskId *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.contract.Transact(opts, "markActionable", taskId)
}

// MarkActionable is a paid mutator transaction binding the contract method 0x51a6418c.
//
// Solidity: function markActionable(uint256 taskId) returns()
func (_AgentTaskManager *AgentTaskManagerSession) MarkActionable(taskId *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.MarkActionable(&_AgentTaskManager.TransactOpts, taskId)
}

// MarkActionable is a paid mutator transaction binding the contract method 0x51a6418c.
//
// Solidity: function markActionable(uint256 taskId) returns()
func (_AgentTaskManager *AgentTaskManagerTransactorSession) MarkActionable(taskId *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.MarkActionable(&_AgentTaskManager.TransactOpts, taskId)
}
...
// GrantTradePermission is a paid mutator transaction binding the contract method 0x0c9159de.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration, uint256 maxAmountPerTrade, uint256 cooldownInterval) returns()
func (_AgentTaskManager *AgentTaskManagerTransactor) GrantTradePermission(opts *bind.TransactOpts, taskId *big.Int, totalBudget *big.Int, duration *big.Int, maxAmountPerTrade *big.Int, cooldownInterval *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.contract.Transact(opts, "grantTradePermission", taskId, totalBudget, duration, maxAmountPerTrade, cooldownInterval)
}

// GrantTradePermission is a paid mutator transaction binding the contract method 0x0c9159de.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration, uint256 maxAmountPerTrade, uint256 cooldownInterval) returns()
func (_AgentTaskManager *AgentTaskManagerSession) GrantTradePermission(taskId *big.Int, totalBudget *big.Int, duration *big.Int, maxAmountPerTrade *big.Int, cooldownInterval *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.GrantTradePermission(&_AgentTaskManager.TransactOpts, taskId, totalBudget, duration, maxAmountPerTrade, cooldownInterval)
}

// GrantTradePermission is a paid mutator transaction binding the contract method 0x0c9159de.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration, uint256 maxAmountPerTrade, uint256 cooldownInterval) returns()
func (_AgentTaskManager *AgentTaskManagerTransactorSession) GrantTradePermission(taskId *big.Int, totalBudget *big.Int, duration *big.Int, maxAmountPerTrade *big.Int, cooldownInterval *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.GrantTradePermission(&_AgentTaskManager.TransactOpts, taskId, totalBudget, duration, maxAmountPerTrade, cooldownInterval)
}

// GrantTradePermission0 is a paid mutator transaction binding the contract method 0xa80edf02.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration) returns()
func (_AgentTaskManager *AgentTaskManagerTransactor) GrantTradePermission0(opts *bind.TransactOpts, taskId *big.Int, totalBudget *big.Int, duration *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.contract.Transact(opts, "grantTradePermission0", taskId, totalBudget, duration)
}

// GrantTradePermission0 is a paid mutator transaction binding the contract method 0xa80edf02.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration) returns()
func (_AgentTaskManager *AgentTaskManagerSession) GrantTradePermission0(taskId *big.Int, totalBudget *big.Int, duration *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.GrantTradePermission0(&_AgentTaskManager.TransactOpts, taskId, totalBudget, duration)
}

// GrantTradePermission0 is a paid mutator transaction binding the contract method 0xa80edf02.
//
// Solidity: function grantTradePermission(uint256 taskId, uint256 totalBudget, uint256 duration) returns()
func (_AgentTaskManager *AgentTaskManagerTransactorSession) GrantTradePermission0(taskId *big.Int, totalBudget *big.Int, duration *big.Int) (*types.Transaction, error) {
	return _AgentTaskManager.Contract.GrantTradePermission0(&_AgentTaskManager.TransactOpts, taskId, totalBudget, duration)
}
